...
import { Save, Search, ShieldCheck, Trash2, Users } from "lucide-react";
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="truncate text-xs text-muted-foreground">
                        {employee.designation || "No designation"} ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· {employee.department || "No department"}
                      </p>
                    </div>
