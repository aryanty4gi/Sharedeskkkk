...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Secure internal messaging and document sharing for Nuberg Engineering employees." },
      ...
      { property: "og:description", content: "Secure internal messaging and document sharing for Nuberg Engineering employees." },
      { name: "twitter:description", content: "Secure internal messaging and document sharing for Nuberg Engineering employees." },
