...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-[#FBFBF9] text-[#222222]">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-[#3B6FA0]/90 via-[#3B6FA0] to-[#3B6FA0]/80 p-12 text-[#FBFBF9]">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">
              {mode === "signin" ? "Please enter your details" : "Create a new workplace account"}
            </p>
          </div>
