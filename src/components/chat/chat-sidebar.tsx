...
import { Plus, Search, MessageSquare, Settings, LogOut, Search as SearchIcon } from "lucide-react";
import { NotificationsMenu } from "./notifications-menu";
import { motion, AnimatePresence } from "framer-motion";
import { supabase } from "@/integrations/supabase/client";
import { fetchConversations, fetchMyProfile } from "@/lib/chat/queries";
                ...
                <>
                  <DropdownMenuLabel>
                    ...
                    <div className="text-xs font-normal text-muted-foreground">
                      {[me.designation, me.department].filter(Boolean).join(" · ") || me.email}
                    </div>
                  </DropdownMenuLabel>
              ...
              {filtered.map((c) => {
                ...
                const preview = c.last_message?.deleted_at
                  ...
                  : c.last_message?.message_type === "file" || c.last_message?.message_type === "image"
                    ? `📎 ${c.last_message.file_name ?? "Attachment"}`
